...
# enable ffmpeg by qinyoyo for ffmpeg command line
...
# enable avcodec, avformat, avutil, avfilter ...  by qinyoyo for ffmpeg command line
...
# enable encoders by qinyoyo for ffmpeg command line
...
# enable muxers by qinyoyo for ffmpeg command line
